...
const PLACEHOLDER_JOKES = [
  ...
  { setup: "HUNGARY?", punchline: "THEN EAT SOMETHING." },
  { setup: "SELFISH?", punchline: "HOW MUCH?" },
  { setup: "BIRD FLU?", punchline: "YEAH, THEY DO THAT." },
  { setup: "BREAK FLUID?", punchline: "NO, YOU CAN'T BE THAT STRONG." },
  { setup: "TREE BARK?", punchline: "NO, THEY DON'T." },
  { setup: "SUNDAY?", punchline: "IT DEPENDS ON THE WEATHER." },
  { setup: "NACHO CHEESE?", punchline: "THEN WHY ARE YOU EATING IT?" },
  { setup: "MEATBALL?", punchline: "WHO IS BALL?" },
  { setup: "FRENCH TOAST?", punchline: "YEAH, I GUESS THEY HAVE TOASTERS." },
  { setup: "HOW DO YOU CATCH A SQUIRREL?", punchline: "CLIMB A TREE AND ACT LIKE A NUT." },
  { setup: "WHY DON'T EGGS TELL JOKES?", punchline: "THEY MIGHT CRACK UP." },
  ...
  { setup: "HOW DO YOU STOP A BULL FROM CHARGING?", punchline: "CANCEL ITS CREDIT CARD." },
  {
    setup: "WHAT DO YOU CALL TWO MONKEYS WHO SHARE AN AMAZON PRIME ACCOUNT?",
    punchline: "PRIME MATES.",
  },
  { setup: "WHY CAN'T A LEOPARD HIDE?", punchline: "HE'S ALWAYS SPOTTED." },
  { setup: "WHY ARE FISH SO SMART?", punchline: "THEY LIVE IN SCHOOLS." },
  { setup: "WHY WAS SIX AFRAID OF SEVEN?", punchline: "BECAUSE SEVEN ATE NINE." },

export function SpeechBubble({ text }: { text: string }) {
  return (
    <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 w-64 -translate-x-1/2">
      <div className="rounded-md border-2 border-foreground bg-card px-3 py-2 font-pixel text-[9px] leading-[1.7] text-foreground shadow-[4px_4px_0_0_var(--color-foreground)]">
        {text || "..."}
      </div>
